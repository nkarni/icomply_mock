    ...
    <b-form>
      ...
      <section class="border-bottom border-secondary mb-4 pb-2">
        <b-row>
          ...
          <b-col cols="8">
            <pph-identity-read-only :form="form"></pph-identity-read-only>
            <h6>Training:</h6>
      ...
      <section class="border-bottom border-secondary mb-4 pb-2">
        <b-row>
          ...
          <b-col cols="8">
            <pph-pqm-read-only :form="form"></pph-pqm-read-only>
          </b-col>
        </b-row>
      </section>
