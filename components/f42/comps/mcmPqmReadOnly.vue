<template>
  <div>
    <p>
      I, <br />Sam JOhn Smith <br />positionName<br />Of orgName, branch, full
      streetAddress
    </p>
    <p>Declare that:</p>
    <ol>
      <li>
        Having made proper inquiries, I believe that the proposed permit holder,
        [PPH Name and position], is a fit and proper person to hold an entry
        permit.
      </li>
      <li>
        Each answer I give at paragraphs (a) to (i) below is true and correct to
    ...
    <review-item
      ...
      :label="
        'a. ' +
        'Has the proposed permit holder ever been convicted of an offence against an industrial law?'
      "
      :value="
    ...
    <review-item
      ...
      :label="
        'b. ' +
        'Has the proposed permit holder ever been convicted of an offence against a law of the Commonwealth, a State, a Territory or a foreign country, involving: <br />(i) entry onto premises; or <br />(ii) fraud ordishonesty; or <br />(iii) intentional use of violence against another person or intentional damage or destruction of property?'
      "
      :value="
        boolToStringWithDetails(
    ...
    <review-item
      ...
      :label="
        'c. ' +
        'Has the proposed permit holder, or any other person (which includes a union), ever been ordered to pay a penalty under the Fair Work Act 2009 or any other industrial law in relation to action taken by the proposed permit holder' +
        '?'
      "
      :value="
        boolToStringWithDetails(
    ...
    <review-item
      ...
      :label="
        'd. ' +
        'Has the proposed permit holder had revoked, suspended or made subject to conditions, any permit issued under Part 3 4 of the Fair Work Act 2009 or a similar law of the Commonwealth (no matter when in force)?'
      "
      :value="
        boolToStringWithDetails(
    ...
    <review-item
      ...
      :label="
        'e. ' +
        'Has the proposed permit holder had cancelled or suspended or had conditions imposed on a right of entry for industrial or occupational health and safety (OHS) purposes, by any court, or other person or body, under a State or Territory industrial law or a State or Territory OHS law?'
      "
      :value="
        boolToStringWithDetails(
    ...
    <review-item
      ...
      :label="
        'f. ' +
        'Has the proposed permit holder been disqualified, by any court, or other person or body, under a State or Territory industrial law or a State or Territory OHS law, from exercising, or applying for, a right of entry for industrial or OHS purposes under that law?'
      "
      :value="
        boolToStringWithDetails(
