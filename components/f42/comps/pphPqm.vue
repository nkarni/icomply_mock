  ...
  <div>
    <Transition>
      <b-row>
        ...
        <b-col class="pl-1">
          <b-form-group
            :label="'Have you ever been convicted of an offence against an industrial law?'
            "
          >
            <b-form-radio-group
    ...
    <Transition>
      <b-row :class="disableConvictedOther ? 'disabled' : ''">
        ...
        <b-col class="pl-1">
          <b-form-group>
            <label>
              Have you ever been convicted of an offence against a law
    ...
    <Transition>
      <b-row :class="disableOrderedToPay ? 'disabled' : ''">
        ...
        <b-col class="pl-1">
          <b-form-group
            :label="
              'Have you, or any other person (which includes a union), ever been ordered to pay a penalty under the Fair Work Act 2009 or any other industrial law in relation to action taken by you?'"
          >
            <b-form-radio-group
    ...
    <Transition>
      <b-row :class="disableHadRevoked ? 'disabled' : ''">
        ...
        <b-col class="pl-1">
          <b-form-group
            :label="'Have you had revoked, suspended or made subject to conditions, any permit issued under Part 3 4 of the Fair Work Act 2009 or a similar law of the Commonwealth (no matter when in force)?'
            "
          >
            <b-form-radio-group
    ...
    <Transition>
      <b-row :class="disableHadConditionsImposed ? 'disabled' : ''">
        ...
        <b-col class="pl-1">
          <b-form-group
            :label="'Have you had cancelled or suspended or had conditions imposed on a right of entry for industrial or occupational health and safety (OHS) purposes, by any court, or other person or body, under a State or Territory industrial law or a State or Territory OHS law?'
            "
          >
            <b-form-radio-group
