      ...
      <section class="border-bottom border-secondary mb-4 pb-2">
        <b-row>
          <b-col cols="4">
            ...
            <p>
              Please check that they are accurate and correct if required, they
              must match your name on your driver license or on an official ID
              document.
            </p>
          </b-col>
          <b-col>
