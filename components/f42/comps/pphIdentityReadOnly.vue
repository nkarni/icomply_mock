<template>
  <div>
    <review-item
      ...
      :compareTo="
        form.admin.permitHolderDataEnteredByAdmin.firstName +
        ' ' +
    ...
    <review-item
      ...
      :doComparison="doComparison"
      :compareTo="
        namesToString(form.admin.permitHolderDataEnteredByAdmin.otherNames)
      "
    ></review-item>
    ...
    <review-item
      ...
      :doComparison="doComparison"
      :compareTo="
        phoneToString(form.admin.permitHolderDataEnteredByAdmin.phones)
      "
    ></review-item>
    ...
    <review-item
      ...
      :doComparison="doComparison"
      :compareTo="
        boolToString(form.admin.permitHolderDataEnteredByAdmin.hasDigitalId)
      "
    ></review-item>
...
export default {
  ...
  methods: {
    ...
    prevPermitToStringAdminEntered() {
      if (
        this.form.admin.permitHolderDataEnteredByAdmin
        ...
        let str =
          "Permit no. " +
          this.form.admin.permitHolderDataEnteredByAdmin.previousPermitNumber;
        if (
          this.form.admin.permitHolderDataEnteredByAdmin
