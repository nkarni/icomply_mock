    ...
    <section class=" mb-4 pb-2">
      <b-row>
        <b-col>
          <h6>Attachments</h6>
          <p>
           Please attach a copy of your dismissal letter if you have one. You don’t need to provide additional attachments at this stage. You can submit them later. We can also ask you to provide extra information or evidence later if we need it.
          </p>
          <p>
      ...
      <b-row>
        <b-col>
          ...
          <notice
            message="<small>Prototype notes: <br>
